...
import { Bell, Check, X, MessageSquare, UserPlus, Heart, Share2, Calendar } from 'lucide-react'
            ...
            return (
              ...
              >
                <div className={`w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 ${
                  ...
                  notification.type === 'friend' ? 'bg-green-100' :
                  ...
                  <Icon className={`w-6 h-6 ${
                    ...
                    notification.type === 'friend' ? 'text-green-600' :
                    notification.type === 'like' ? 'text-red-600' :
                    notification.type === 'event' ? 'text-primary' :
                    'text-gray-600'
                  }`} />
                </div>
