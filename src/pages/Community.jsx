...
const communities = [
  {
    ...
    description:
      "For CS students and enthusiasts. Share projects, discuss topics, and network.",
    members: 234,
    posts: 156,
    category: "Academic",
  ...
  },
  {
    ...
    description:
      "Share your photos, learn techniques, and participate in photo walks.",
    members: 156,
    posts: 89,
    category: "Arts",
  ...
  },
  {
    ...
    name: "Sports & Fitness",
    description:
      "Stay active and connect with fellow athletes and fitness enthusiasts.",
    members: 312,
    posts: 203,
    category: "Sports",
...
const recentPosts = [
  {
    ...
    content:
      "Looking for 3-4 people to study algorithms together. Meeting weekly on Tuesdays.",
    likes: 12,
    comments: 5,
    time: "2h ago",
  },
  {
    ...
    content:
      "We're hosting a pitch event next month. Sign up if you want to present your idea!",
    likes: 34,
    comments: 8,
    time: "5h ago",
  },
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      >
        {communities
          .filter(
            (c) => activeTab === "all" || joinedCommunities.includes(c.id),
          )
          .map((community) => (
            <motion.div
              key={community.id}
      ...
      <div className="card">
        <h2 className="text-xl font-bold text-gray-900 mb-4">
          Recent Posts from Your Communities
        </h2>
