          ...
          >
            <div className="flex justify-between items-start">
              <div className="flex gap-3">
                <div
                  className={`w-8 h-8 rounded-full flex items-center justify-center ${getPriorityColor(action.priority)} bg-opacity-50`}
                >
                  {getIcon(action.type)}
                </div>
                <div>
              ...
              <span
                className={`text-[10px] font-bold uppercase px-2 py-0.5 rounded-full ${getPriorityColor(action.priority)}`}
              >
                {action.priority}
              </span>
            </div>
